...
POSE: ${pose[1]}.
The supplied image is the canonical approved master reference. Preserve exact identity, apparent age, facial geometry, body proportions, hair, eyes, complexion, wardrobe construction, footwear, emblem placement, accessories, and asymmetric left/right details. LEFT and RIGHT always mean the CHARACTER'S anatomical left/right, never the viewer's. Do not mirror or swap asymmetric equipment. IMPORTANT anatomical orientation for a front-facing image: the CHARACTER'S LEFT appears on the VIEWER'S RIGHT, and the CHARACTER'S RIGHT appears on the VIEWER'S LEFT. Pixel's scanner gauntlet MUST therefore appear on the VIEWER'S RIGHT. Pixel's opposite RIGHT arm must remain normal white/cyan/black techwear with NO gold or mechanical redesign. Pixel's chest badge MUST be the canonical blue hexagonal Keeper badge with a clearly readable gold C. Forge's bronze mechanical RIGHT arm MUST therefore appear on the VIEWER'S LEFT. Sterling's gold monocle MUST remain over his anatomical RIGHT eye; in a front-facing image this is the VIEWER'S LEFT. Do not redesign the character. Only change pose, expression, camera angle, and specifically requested prop. Premium stylized high-detail 3D/CGI comic render. Full body unless the requested camera angle requires otherwise. Clean pure white background. No other characters. For neutral poses, hands must be empty unless the pose explicitly requests a prop. Do not invent furniture, scenery, bars, tools, shields, weapons, or props. No embedded text, number, pose label, caption, QA graphic, border, signature, or watermark.`;
}
